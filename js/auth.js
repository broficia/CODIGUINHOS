...
function checkStrength(val){
  ...
  const l=lv[s]||lv[0];b.style.width=l.w;b.style.background=l.c;if(t)t.textContent=l.l;
}
...
async function handleRegister(e){
  ...
  const refCode=localStorage.getItem('unoRefCode')||null;
  const user={id:'u_'+Date.now(),name,email,balance:'0.00',level:1,xp:0,wins:0,games:0,referredBy:refCode,createdAt:new Date().toISOString()};
